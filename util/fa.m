...
nVar=76;                 % Number of Decision Variables

VarSize=[1 nVar];       % Decision Variables Matrix Size

VarMin= 1;             % Decision Variables Lower Bound
VarMax= 12;             % Decision Variables Upper Bound
    ...
    for i=1:nPop
        ...
        for j=1:nPop
            if pop(j).Cost < pop(i).Cost
                ...
                newsol.Position = round(pop(i).Position ...
                ...
                newsol.Cost=CostFunction(round(newsol.Position));
